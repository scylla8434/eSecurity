...
<head>
  ...
  <title>eSecurity | Log in</title>
<style>
/* Custom styles for interesting buttons */
 .btn-interesting {
...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>Admin</b> | eSecurity</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
         <a href="forgot-password.php" class="btn-interesting">Forgot Password?</a>
       </p>
       <p>
         <a href="../index.php" class="btn-interesting">Back Home</a>
